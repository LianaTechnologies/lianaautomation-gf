...
LianaAutomation for Gravity Forms is an integration plugin for a LianaAutomation marketing automation platform. It enables the creation of automations and segmenting customer data in the marketing automation solution LianaAutomation, based on form data collected from Gravity Forms.
...
1. Formsend event results in LianaAutomation
...
Report bugs on our [GitHub repository](https://github.com/LianaTechnologies/lianaautomation-gf/issues).
...
= LianaAutomation for Gravity Forms is awesome! Can I contribute? =

Yes, you can! Join in on our [GitHub repository](https://github.com/LianaTechnologies/lianaautomation-gf)
...
In the search field type "Liana" then click "Search Plugins". Once you’ve found us, you can install it by clicking "Install Now" and WordPress will take it from there.
...
= 1.0.9 2023-03-29 =
* **Fixed:** Use lianaautomation_gf_options instead of lianaautomation_gravityforms_options in gform_after_submission action
* **Fixed:** Documentation URLs
* **Support** Tested with WordPress 6.2

= 1.0.8 2022-10-16 = Initial public release
